...
import 'package:loginandregister_flutter/Screens/services/drivers.dart';
import 'package:loginandregister_flutter/Screens/services/map_requests.dart';
import 'package:loginandregister_flutter/Screens/services/ride_requests.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:uuid/uuid.dart';
import '../Screens/helpers/constants.dart';
import '../Screens/helpers/style.dart';
import '../Screens/models/driver.dart';
import '../Screens/models/ride_Request.dart';
import '../Screens/models/route.dart';
import '../Screens/models/user.dart';
import '../Screens/widgets/custom_btn.dart';
import '../Screens/widgets/custom_text.dart';
import '../Screens/widgets/stars.dart';
...
//    here we are updating the drivers markers
  ...
  _setCustomMapPin() async {
    ...
    locationPin = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(devicePixelRatio: 2.5), 'Assets/user.png');
  }
  ...
  _listenToDriver() {
    driverStream = _driverService.driverStream().listen((event) {
      event.docChanges.forEach((change) async {
        if (change.doc.get('id') == driverModel.id) {
          driverModel = DriverModel.fromFirestore(change.doc.data());
